...
Target: state claims and actions directly. Use contrast only for real logical distinctions.
...
- "land" as a change verb
- filler "today"

Rewrite every match as one or more direct claims.

Bad: "This is not just a cache bug, but a state ownership bug."
Good: "The underlying bug here is in state ownership."

Final scan: check every reply for every banned form; rewrite all matches.
